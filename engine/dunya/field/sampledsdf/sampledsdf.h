...
static_assert(DistanceField<SampledSdf>);
static_assert(MaterialQueryable<SampledSdf>);
static_assert(GradientQueryable<SampledSdf>);
static_assert(StepBounded<SampledSdf>);
