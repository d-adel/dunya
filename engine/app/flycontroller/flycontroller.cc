...
bool FlyController::looking() const noexcept {
  return m_looking;
}

void FlyController::clear() noexcept {
  m_state = {};
}

void FlyController::setLookMode(bool looking) {
...
void FlyController::update(float dt, bool acceptsInput) {
...
dunya::field::Ray FlyController::cursorRay(
  VkExtent2D extent,
